...
var Rating = (_temp = _class = function (_Component) {
    ...
    Rating.prototype.render = function render() {
        ...
        for (var i = 0; i < count; i++) {
            ...
            var iconCls = (0, _classnames2.default)((_classNames = {
                hover: hoverValue > 0 && isCurrent,
                clicked: clicked && isCurrent
            }, _classNames[prefix + 'rating-symbol-icon'] = !iconType, _classNames));
        ...
        var ratingCls = (0, _classnames2.default)([prefix + 'rating', prefix + 'rating-' + size], (_classNames2 = {}, _classNames2[prefix + 'rating-grade-low'] = value <= count * 0.4, _classNames2[prefix + 'rating-grade-high'] = value > count * 0.4, _classNames2[prefix + 'rating-stroke-mode'] = strokeMode, _classNames2.hover = hoverValue > 0, _classNames2), className);

        var baseCls = (0, _classnames2.default)(prefix + 'rating-base', (_classNames3 = {}, _classNames3[prefix + 'rating-base-disabled'] = disabled, _classNames3));
