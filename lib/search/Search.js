...
var Search = (_temp = _class = function (_React$Component) {
    ...
    Search.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            rtl = _props.rtl,
            icons = _props.icons,
            others = (0, _objectWithoutProperties3.default)(_props, ['shape', 'filter', 'hasIcon', 'disabled', 'placeholder', 'type', 'className', 'style', 'size', 'prefix', 'searchText', 'dataSource', 'filterProps', 'buttonProps', 'popupContent', 'followTrigger', 'hasClear', 'visible', 'locale', 'rtl', 'icons']);
