        ...
        if (type === 'normal') {
            extra = React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Icon, { className: prefixCls + '-up-icon' })
                ),
                React.createElement(
                    Button,
                    ...
                    React.createElement(Icon, { className: prefixCls + '-down-icon' })
                )
            );
        } else {
            addonBefore = React.createElement(
                ...
                React.createElement(Icon, { className: prefixCls + '-minus-icon' })
            );
            addonAfter = React.createElement(
                ...
                React.createElement(Icon, { className: prefixCls + '-add-icon' })
            );
        }
